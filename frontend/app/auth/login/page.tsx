      ...
      >
        ...
        <form action={formAction} className="flex flex-col gap-5">
          ...
          <button 
            type="submit"
            disabled={isPending}
            className="group mt-4 w-full py-3.5 px-4 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 rounded-xl font-semibold text-white transition-all shadow-lg shadow-purple-500/25 flex items-center justify-center gap-2 disabled:opacity-50"
          >
