...
import { Bot, Search, FileText, ArrowRight, Menu, X, CheckCircle, Users, TrendingUp, Shield, Star, Mail, Phone, MapPin, Link, MessageCircle, Code } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Practice with intelligent voice-enabled AI recruiter tailored to your profile",
    ...
    },
    {
      ...
      description: "Get instant AI-powered resume scoring and optimization suggestions",
    ...
    },
    {
      ...
      description: "Discover curated opportunities that match your skills and market value",
  ...
  const testimonials = [
    {
      ...
      content: "HireSense AI helped me optimize my resume and land my dream job. The interview practice was invaluable!",
      rating: 5
    },
    {
      name: "Michael Chen",
      role: "Product Manager",
      content: "The AI interview coach prepared me better than any human recruiter. Highly recommended!",
      rating: 5
    },
    {
      name: "Emily Davis",
      role: "UX Designer",
      content: "Finally found jobs that actually match my skills. The smart matching is incredibly accurate.",
      rating: 5
    }
  ];
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative z-10 px-4 sm:px-6 lg:px-8 pt-20 pb-32">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Transform your job search with intelligent resume analysis, AI interview practice, and personalized job matching.
          </motion.p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className={`relative group p-8 rounded-2xl border border-white/10 bg-gradient-to-br ${feature.gradient} backdrop-blur-xl hover:border-white/20 transition-all`}
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-400 mb-8 leading-relaxed">
                We combine cutting-edge AI technology with industry expertise to provide you with the most comprehensive career development platform available.
              </p>
              
              <div className="space-y-6">
                {[
                  { icon: <CheckCircle className="w-5 h-5" />, title: "Proven Results", desc: "95% success rate in helping candidates land interviews" },
                  { icon: <Users className="w-5 h-5" />, title: "Expert-Backed", desc: "Developed with top recruiters and hiring managers" },
                  { icon: <TrendingUp className="w-5 h-5" />, title: "Career Growth", desc: "Continuous learning and skill development tracking" },
                  { icon: <Shield className="w-5 h-5" />, title: "Privacy First", desc: "Your data is secure and never shared without consent" }
                ].map((item, index) => (
                ...
                <div className="grid grid-cols-2 gap-6">
                  {testimonials.map((testimonial, index) => (
                    <div key={index} className="p-4 rounded-xl bg-white/5 border border-white/10">
                      ...
                      <p className="text-sm text-gray-300 mb-2 italic">"{testimonial.content}"</p>
                      <div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Join thousands of professionals who've already landed their dream jobs with HireSense AI.
              </p>
              <button
                onClick={() => router.push('/login')}
      ...
      {/* Footer */}
      <footer id="contact" className="relative z-10 border-t border-white/10 bg-black/50 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                Empowering professionals with AI-driven career coaching and job matching technology.
              </p>
              <div className="flex items-center gap-4">
          ...
          <div className="border-t border-white/10 mt-8 pt-8 text-center">
            <p className="text-gray-400 text-sm">
              © 2024 HireSense AI. All rights reserved. | Privacy Policy | Terms of Service
            </p>
          </div>
        </div>
      </footer>
