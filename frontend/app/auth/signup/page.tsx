    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center overflow-hidden relative">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-zinc-400 text-center">Start your journey with us.</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-zinc-500">
          Already have an account? <Link href="/auth/login" className="text-purple-400 hover:text-purple-300 transition-colors cursor-pointer">Log in</Link>
        </div>
      </motion.div>
    </div>
  );
