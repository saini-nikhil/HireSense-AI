    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center overflow-hidden relative">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-linear-to-r from-purple-400 to-blue-400 mb-2">
            Welcome Back
          </h1>
          <p className="text-zinc-400 text-center">Log in to continue your journey.</p>
        </div>
        ...
        <form action={formAction} className="flex flex-col gap-5">
          ...
          <button 
            type="submit"
            disabled={isPending}
            className="group mt-4 w-full py-3.5 px-4 bg-linear-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 rounded-xl font-semibold text-white transition-all shadow-lg shadow-purple-500/25 flex items-center justify-center gap-2 disabled:opacity-50"
          >
        ...
        <div className="mt-6">
          <div className="relative flex items-center py-2">
            ...
            <span className="shrink-0 mx-4 text-zinc-500 text-sm">or</span>
            <div className="grow border-t border-zinc-800"></div>
          </div>
          <a
            href={getGoogleOAuthUrl()}
            className="mt-4 w-full py-3 px-4 bg-zinc-800/50 hover:bg-zinc-800 border border-white/10 rounded-xl font-medium text-white transition-all flex items-center justify-center gap-3"
          >
        ...
        <div className="mt-8 text-center text-sm text-zinc-500">
          Don&apos;t have an account? <Link href="/auth/signup" className="text-purple-400 hover:text-purple-300 transition-colors cursor-pointer">Sign up</Link>
        </div>
      </motion.div>
    </div>
  );
